...
const (
	// Label holds the string label denoting the icingcondition type in the database.
	Label = "icing_condition"
	...
	// Table holds the table name of the icingcondition in the database.
	Table = "icing_conditions"
)

// Columns holds all SQL columns for icingcondition fields.
var Columns = []string{
	FieldID,
	FieldIntensity,
	FieldMinAltitude,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "icing_conditions"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"forecast_icing_conditions",
}
