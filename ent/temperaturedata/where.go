...
func ID(id int) predicate.TemperatureData {
...
func IDEQ(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
...
func IDLT(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.TemperatureData {
	return predicate.TemperatureData(func(s *sql.Selector) {
