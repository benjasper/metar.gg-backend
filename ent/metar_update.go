...
func (mu *MetarUpdate) SetLatitude(f float64) *MetarUpdate {
...
func (mu *MetarUpdate) SetNillableLatitude(f *float64) *MetarUpdate {
	if f != nil {
		mu.SetLatitude(*f)
	}
	return mu
...
func (mu *MetarUpdate) AddLatitude(f float64) *MetarUpdate {
	mu.mutation.AddLatitude(f)
	return mu
}

// ClearLatitude clears the value of the "latitude" field.
func (mu *MetarUpdate) ClearLatitude() *MetarUpdate {
	mu.mutation.ClearLatitude()
	return mu
}

// SetLongitude sets the "longitude" field.
func (mu *MetarUpdate) SetLongitude(f float64) *MetarUpdate {
...
func (mu *MetarUpdate) SetNillableLongitude(f *float64) *MetarUpdate {
	if f != nil {
		mu.SetLongitude(*f)
	}
	return mu
...
func (mu *MetarUpdate) AddLongitude(f float64) *MetarUpdate {
	mu.mutation.AddLongitude(f)
	return mu
}

// ClearLongitude clears the value of the "longitude" field.
func (mu *MetarUpdate) ClearLongitude() *MetarUpdate {
	mu.mutation.ClearLongitude()
	return mu
}

// SetElevation sets the "elevation" field.
func (mu *MetarUpdate) SetElevation(f float64) *MetarUpdate {
	mu.mutation.ResetElevation()
	mu.mutation.SetElevation(f)
	return mu
}

// SetNillableElevation sets the "elevation" field if the given value is not nil.
func (mu *MetarUpdate) SetNillableElevation(f *float64) *MetarUpdate {
	if f != nil {
		mu.SetElevation(*f)
	}
	return mu
...
func (mu *MetarUpdate) AddElevation(f float64) *MetarUpdate {
	mu.mutation.AddElevation(f)
	return mu
}

// ClearElevation clears the value of the "elevation" field.
func (mu *MetarUpdate) ClearElevation() *MetarUpdate {
	mu.mutation.ClearElevation()
	return mu
}
...
func (mu *MetarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if mu.mutation.LatitudeCleared() {
	...
	if mu.mutation.LongitudeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Column: metar.FieldLongitude,
		})
	}
	if value, ok := mu.mutation.Elevation(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
	...
	if value, ok := mu.mutation.AddedElevation(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: metar.FieldElevation,
	...
	if mu.mutation.ElevationCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Column: metar.FieldElevation,
		})
...
// SetLatitude sets the "latitude" field.
func (muo *MetarUpdateOne) SetLatitude(f float64) *MetarUpdateOne {
...
// SetNillableLatitude sets the "latitude" field if the given value is not nil.
func (muo *MetarUpdateOne) SetNillableLatitude(f *float64) *MetarUpdateOne {
	if f != nil {
		muo.SetLatitude(*f)
	}
	return muo
...
// AddLatitude adds f to the "latitude" field.
func (muo *MetarUpdateOne) AddLatitude(f float64) *MetarUpdateOne {
	muo.mutation.AddLatitude(f)
	return muo
}

// ClearLatitude clears the value of the "latitude" field.
func (muo *MetarUpdateOne) ClearLatitude() *MetarUpdateOne {
	muo.mutation.ClearLatitude()
	return muo
}

// SetLongitude sets the "longitude" field.
func (muo *MetarUpdateOne) SetLongitude(f float64) *MetarUpdateOne {
...
// SetNillableLongitude sets the "longitude" field if the given value is not nil.
func (muo *MetarUpdateOne) SetNillableLongitude(f *float64) *MetarUpdateOne {
	if f != nil {
		muo.SetLongitude(*f)
	}
	return muo
...
// AddLongitude adds f to the "longitude" field.
func (muo *MetarUpdateOne) AddLongitude(f float64) *MetarUpdateOne {
	muo.mutation.AddLongitude(f)
	return muo
}

// ClearLongitude clears the value of the "longitude" field.
func (muo *MetarUpdateOne) ClearLongitude() *MetarUpdateOne {
	muo.mutation.ClearLongitude()
	return muo
}

// SetElevation sets the "elevation" field.
func (muo *MetarUpdateOne) SetElevation(f float64) *MetarUpdateOne {
	muo.mutation.ResetElevation()
	muo.mutation.SetElevation(f)
	return muo
}

// SetNillableElevation sets the "elevation" field if the given value is not nil.
func (muo *MetarUpdateOne) SetNillableElevation(f *float64) *MetarUpdateOne {
	if f != nil {
		muo.SetElevation(*f)
	}
	return muo
...
// AddElevation adds f to the "elevation" field.
func (muo *MetarUpdateOne) AddElevation(f float64) *MetarUpdateOne {
	muo.mutation.AddElevation(f)
	return muo
}

// ClearElevation clears the value of the "elevation" field.
func (muo *MetarUpdateOne) ClearElevation() *MetarUpdateOne {
	muo.mutation.ClearElevation()
	return muo
}
...
func (muo *MetarUpdateOne) sqlSave(ctx context.Context) (_node *Metar, err error) {
	...
	if muo.mutation.LatitudeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Column: metar.FieldLatitude,
		})
	...
	if muo.mutation.LongitudeCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Column: metar.FieldLongitude,
		})
	}
	if value, ok := muo.mutation.Elevation(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: metar.FieldElevation,
	...
	if value, ok := muo.mutation.AddedElevation(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Value:  value,
			Column: metar.FieldElevation,
	...
	if muo.mutation.ElevationCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeFloat64,
			Column: metar.FieldElevation,
		})
