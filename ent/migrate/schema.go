...
var (
	...
	RunwaysColumns = []*schema.Column{
		...
		{Name: "low_runway_heading", Type: field.TypeInt, Nullable: true},
		{Name: "low_runway_displaced", Type: field.TypeInt, Nullable: true},
		...
		{Name: "high_runway_heading", Type: field.TypeInt, Nullable: true},
		{Name: "high_runway_displaced", Type: field.TypeInt, Nullable: true},
