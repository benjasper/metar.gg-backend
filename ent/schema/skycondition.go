...
func (SkyCondition) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("cloud_base").Optional().Nillable().Comment("Cloud base in feet.").Annotations(entgql.Skip(entgql.SkipType)),
...
// Mixin of the SkyCondition.
func (SkyCondition) Mixin() []ent.Mixin {
	return []ent.Mixin{
		IDMixin{},
	}
}
