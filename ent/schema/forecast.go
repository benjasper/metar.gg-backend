...
func (Forecast) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("turbulence_conditions", TurbulenceCondition.Type).Comment("The turbulence conditions."),
		edge.To("icing_conditions", IcingCondition.Type).Comment("The icing conditions."),
		edge.To("temperature_data", TemperatureData.Type).Comment("The temperature data."),
	}
}
